...
/** 保存当前身上的武器 */
let SaveItemURL =
  "http://127.0.0.1:4523/m1/3609519-0-default/plugins/setmarkosaveitem";
/** 获取保存的武器列表 */
let getSaveItemURL =
  "http://127.0.0.1:4523/m1/3609519-0-default/plugins/getmarkosaveitem";
/** 关闭武器菜单 */
...
MarkoMods.items = [
  {
    type: "page",
    title: "原版武器",
    page: await getDefaultWeapon(),
  },
  {
    type: "page",
    title: "读取配置",
    page: await getSaveItem(),
  },
  {
    type: "page",
    title: "保存配置",
    page: new ExPage("保存配置", [
      {
        type: "divider",
      },
      {
